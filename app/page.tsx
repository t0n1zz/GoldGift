    ...
    <div className="min-h-screen bg-background text-foreground flex flex-col">
      ...
      <main className="mx-auto max-w-5xl px-4 py-20 sm:py-28 flex-1">
        <section className="text-center">
          ...
          <p className="mt-5 text-lg text-stone-600 dark:text-stone-300 max-w-xl mx-auto leading-relaxed">
        ...
        <section className="mt-20 text-center">
          <h2 className="text-xl font-semibold text-stone-900 dark:text-stone-100">How it works</h2>
          <div className="mt-8 grid gap-8 sm:grid-cols-3 max-w-3xl mx-auto">
            <div className="flex flex-col items-center">
              ...
              <h3 className="mt-4 font-medium text-stone-900 dark:text-stone-100">Create</h3>
              <p className="mt-1 text-sm text-stone-600 dark:text-stone-300">Pick amount, occasion, and message. Pay with USDC; we convert to gold.</p>
            </div>
            <div className="flex flex-col items-center">
              ...
              <h3 className="mt-4 font-medium text-stone-900 dark:text-stone-100">Share</h3>
              <p className="mt-1 text-sm text-stone-600 dark:text-stone-300">Send the link or share as a Solana Blink—Twitter, Discord, anywhere.</p>
            </div>
            <div className="flex flex-col items-center">
              ...
              <h3 className="mt-4 font-medium text-stone-900 dark:text-stone-100">Claim</h3>
              <p className="mt-1 text-sm text-stone-600 dark:text-stone-300">Recipient opens the link, connects a wallet, and claims the gold.</p>
            </div>
          </div>
        </section>
        ...
        <section className="mt-24 grid gap-6 sm:grid-cols-3">
          <div className="rounded-2xl border border-stone-200/70 dark:border-stone-700 bg-white dark:bg-stone-900 p-6 shadow-sm">
            ...
            <h3 className="mt-3 font-medium text-stone-900 dark:text-stone-100">Gold-backed</h3>
          ...
          <div className="rounded-2xl border border-stone-200/70 dark:border-stone-700 bg-white dark:bg-stone-900 p-6 shadow-sm">
            <span className="text-2xl" aria-hidden>🔗</span>
            <h3 className="mt-3 font-medium text-stone-900 dark:text-stone-100">Blinks</h3>
            <p className="mt-1.5 text-sm text-stone-600 dark:text-stone-300 leading-relaxed">
          ...
          <div className="rounded-2xl border border-stone-200/70 dark:border-stone-700 bg-white dark:bg-stone-900 p-6 shadow-sm">
            <span className="text-2xl" aria-hidden>🎁</span>
            <h3 className="mt-3 font-medium text-stone-900 dark:text-stone-100">Beautiful cards</h3>
            <p className="mt-1.5 text-sm text-stone-600 dark:text-stone-300 leading-relaxed">
